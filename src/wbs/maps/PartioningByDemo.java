...
public class PartioningByDemo {
        ...
        public static void main(String[] args) {
                ...
                System.out.println("----- die Methode forEach() von map -----");
                partition.forEach((k,v) -> System.out.println(k + " -> " + v));

                System.out.println("--- foreach-Schleife über Map.Entry");
                ...
                /*
                allgemeine Minimalregeln:

                1. Formatierung (!)
                2. Konventionen für Bezeichner. Methoden beginnen mit Kleinbuchstaben. Enums, Klassen, etc. mit Großbuchstaben
                3. If-Anweisungen IMMER mit geschweiften Klammern setzen, auch bei einer Zeile Code im Body.
                4. Sprechende Bezeichner
                 */
        }
