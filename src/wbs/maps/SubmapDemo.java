...
public class SubmapDemo {
        ...
        public static void main(String[] args) {
                ...
                submap.put(4, "vier");
                System.out.println(map);  // {1=eins, 3=drei, 4=vier, 7=sieben, 10=zehn}
                map.remove(7);
                System.out.println(submap);  // {3=drei, 4=vier} //Submap ist KEINE Kopie, sondern sie operiert auf der tatsächlichen Map.
                try {
                        submap.put(11, "elf");
                }
