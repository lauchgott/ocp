...
public class TerminalOperationsDemo {
    public static void main(String[] args) {
        ...
        System.out
                .println(Arrays.toString(Stream.of(1, 2, 3).toArray()));
        ...
        System.out.println(Stream.of("a", "ccc", "bb")
        ...
        Optional<String> optional = Stream.of("a", "ccc", "bb")
                .findFirst();
